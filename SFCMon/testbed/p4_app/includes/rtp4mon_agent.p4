...
action add_iblt_entry(inout rtp4mon_metadata_t meta) {

    bf_flow_filter.write(meta.bf_idx1, 0b1);
    bf_flow_filter.write(meta.bf_idx2, 0b1);
    bf_flow_filter.write(meta.bf_idx3, 0b1);

    hash(meta.iblt_idx1, HashAlgorithm.my_hash1,
        32w0,
        {meta.flow_id_bf},
        IBLT_SIZE);
    hash(meta.iblt_idx2, HashAlgorithm.my_hash2,
        32w0,
        {meta.flow_id_bf},
        IBLT_SIZE);
    hash(meta.iblt_idx3, HashAlgorithm.my_hash3,
        32w0,
        {meta.flow_id_bf},
        IBLT_SIZE);
